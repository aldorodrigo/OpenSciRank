...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        // Force local disk: con AWS_* en .env Livewire defaultea a 's3' (signed
        // direct upload) y deja sólo el .json marker en storage/app/private/livewire-tmp
        // mientras el .pdf real se sube a S3 → al validar/leer falla
        // UnableToRetrieveMetadata porque busca el .pdf en disco local.
