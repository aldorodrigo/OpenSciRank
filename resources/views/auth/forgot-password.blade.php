    ...
    <div class="flex min-h-[60vh] items-center justify-center py-12">
        <div class="w-full max-w-md">
            <div class="rounded-xl bg-white p-8 shadow-lg dark:bg-gray-900">
                <h1 class="mb-2 text-2xl font-bold text-gray-900 dark:text-white">{{ __('Reset Password') }}</h1>
                <p class="mb-6 text-sm text-gray-600 dark:text-gray-400">{{ __('Enter your email and we will send you a link to reset your password.') }}</p>
                ...
                <p class="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
                    <a href="{{ route('login') }}" class="font-medium text-indigo-600 hover:underline dark:text-indigo-400">{{ __('Back to sign in') }}</a>
                </p>
            </div>
        </div>
    </div>
