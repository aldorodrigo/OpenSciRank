        ...
        <div class="w-full max-w-sm">
            ...
            <div class="rounded-2xl border border-gray-200 bg-white p-8 shadow-xl dark:border-gray-800 dark:bg-gray-900">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-5">
                    ...
                    <div x-data="{ show: false }">
                        ...
                        <div class="relative">
                            <input :type="show ? 'text' : 'password'" id="password" name="password" required
                                placeholder="••••••••"
                                class="w-full rounded-xl border border-gray-300 bg-gray-50 pl-4 pr-12 py-3 transition focus:border-blue-500 focus:bg-white focus:ring-2 focus:ring-blue-500/20 dark:border-gray-700 dark:bg-gray-800 dark:text-white">
                            <button type="button" @click="show = !show" class="absolute inset-y-0 right-0 flex items-center pr-4 text-gray-400 hover:text-brand dark:hover:text-blue-400">
                                <template x-if="!show">
                    ...
                    <div class="flex items-center justify-between">
                        <label class="flex cursor-pointer items-center">
                            <input type="checkbox" name="remember" class="h-4 w-4 rounded border-gray-300 text-brand focus:ring-blue-500">
                            <span class="ml-2 text-sm text-gray-600 dark:text-gray-400">{{ __('Remember me') }}</span>
                        </label>
                        <a href="{{ route('password.request') }}" class="text-sm font-medium text-brand hover:text-blue-500 dark:text-blue-400">
                ...
                <p class="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <a href="{{ route('register') }}" class="font-medium text-brand hover:underline dark:text-blue-400">{{ __('Sign Up') }}</a>
                </p>
            </div>
        </div>
    </div>
