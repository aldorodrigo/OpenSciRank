<x-layouts.app :title="__('Confirm Password - Editorial Standards Platform')">
    ...
    <div class="flex min-h-[60vh] items-center justify-center py-12">
        <div class="w-full max-w-md">
            <div class="rounded-xl bg-white p-8 shadow-lg dark:bg-gray-900">
                <h1 class="mb-2 text-2xl font-bold text-gray-900 dark:text-white">{{ __('Confirm Password') }}</h1>
