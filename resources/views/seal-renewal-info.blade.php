        ...
        <div class="container mx-auto px-4">
            <div class="mx-auto max-w-5xl">
                ...
                <div class="grid gap-6 md:grid-cols-3">
                    ...
                    <div class="rounded-xl border border-gray-200 p-6 dark:border-gray-700">
                        <div class="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-emerald-100 dark:bg-emerald-900/40">
                    ...
                    <div class="rounded-xl border border-gray-200 p-6 dark:border-gray-700">
                        <div class="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-amber-100 dark:bg-amber-900/40">
                            <svg class="h-6 w-6 text-amber-600 dark:text-amber-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                        </div>
