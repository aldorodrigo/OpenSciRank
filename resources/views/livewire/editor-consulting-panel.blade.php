    ...
    <div class="container mx-auto px-4">
        ...
        <div class="mb-8 flex flex-wrap items-center justify-between gap-4">
            ...
            <button
                ...
                class="inline-flex items-center gap-2 rounded-lg border border-indigo-300 bg-white px-4 py-2 text-sm font-medium text-indigo-700 shadow-sm transition hover:bg-indigo-50 dark:border-indigo-700 dark:bg-gray-800 dark:text-indigo-300 dark:hover:bg-indigo-950/40">
        ...
        <div
            ...
            class="mb-6 flex items-center gap-3 rounded-xl border px-4 py-3 text-sm shadow
                {{ $toast['type'] === 'success' ? 'border-emerald-200 bg-emerald-50 text-emerald-800 dark:border-emerald-800 dark:bg-emerald-950/30 dark:text-emerald-200' : 'border-red-200 bg-red-50 text-red-800 dark:border-red-800 dark:bg-red-950/30 dark:text-red-200' }}">
        ...
        <div class="flex flex-col items-center justify-center rounded-2xl border border-dashed border-gray-300 bg-white py-16 text-center dark:border-gray-700 dark:bg-gray-900">
            ...
            <button
                type="button"
                wire:click="$set('showHireModal', true)"
                class="mt-6 inline-flex items-center gap-2 rounded-lg bg-indigo-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-indigo-500">
        ...
        <section class="mb-8">
            ...
            <div class="space-y-4">
                ...
                <div class="rounded-2xl border-2 border-indigo-300 bg-indigo-50 p-6 shadow-sm dark:border-indigo-700 dark:bg-indigo-950/30">
                    <div class="mb-4 flex flex-wrap items-start justify-between gap-3">
                        <div>
                            <span class="inline-flex items-center rounded-full bg-indigo-600 px-2.5 py-0.5 text-xs font-semibold text-white">Acción requerida</span>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex flex-wrap items-center gap-3 rounded-xl border border-indigo-200 bg-white px-4 py-3 dark:border-indigo-800 dark:bg-gray-900">
                            <div class="flex-1">
                            ...
                            <button
                                ...
                                class="inline-flex items-center gap-1.5 rounded-lg bg-indigo-600 px-4 py-1.5 text-sm font-semibold text-white transition hover:bg-indigo-500 disabled:opacity-50">
                    ...
                    <div class="mt-4 border-t border-indigo-200 pt-4 dark:border-indigo-800">
                        <button
                            type="button"
                ...
                <div class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-900">
                    ...
                    <div class="mt-3 space-y-2">
                        <div class="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
                            <svg class="h-4 w-4 shrink-0 text-emerald-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
    ...
    <div
        ...
        <div class="relative z-10 w-full max-w-2xl rounded-2xl bg-white p-6 shadow-2xl dark:bg-gray-900">
            ...
            <div class="grid gap-4 md:grid-cols-2">
                ...
                <div class="flex flex-col rounded-xl border-2 {{ $hasEvaluatedJournal ? 'border-indigo-300 bg-indigo-50 dark:border-indigo-700 dark:bg-indigo-950/20' : 'border-gray-200 bg-gray-50 opacity-60 dark:border-gray-700 dark:bg-gray-800' }} p-5">
                    ...
                    @if($hasEvaluatedJournal)
                        ...
                        <a
                            ...
                            class="mt-auto inline-flex items-center justify-center rounded-lg bg-indigo-600 px-4 py-2 text-sm font-semibold text-white transition hover:bg-indigo-500">
                            Comprar
                        </a>
                    @else
                ...
                @endphp
                <div class="flex flex-col rounded-xl border-2 border-purple-300 bg-purple-50 p-5 dark:border-purple-700 dark:bg-purple-950/20">
                    <div class="mb-3 flex items-center justify-between">
                    ...
                    <a
                        ...
                        class="mt-auto inline-flex items-center justify-center rounded-lg bg-purple-600 px-4 py-2 text-sm font-semibold text-white transition hover:bg-purple-500">
                        Comprar
                    </a>
                    @else
                    <span class="mt-auto inline-flex items-center justify-center rounded-lg bg-gray-300 px-4 py-2 text-sm font-semibold text-gray-500 cursor-not-allowed dark:bg-gray-700 dark:text-gray-400">
    ...
    <div
        ...
        <div class="relative z-10 w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl dark:bg-gray-900">
            ...
            <textarea
                ...
                class="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm text-gray-700 placeholder-gray-400 focus:border-indigo-400 focus:outline-none focus:ring-1 focus:ring-indigo-400 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200 dark:placeholder-gray-500"></textarea>
