...
<div class="bg-gray-50 py-8 dark:bg-gray-950">
    <div class="container mx-auto max-w-3xl px-4">
        ...
        <nav class="mb-6 text-sm text-gray-500 dark:text-gray-400">
            ...
            <span class="text-gray-900 dark:text-white">{{ __('My Profile') }}</span>
        </nav>

        <h1 class="mb-8 text-3xl font-bold text-gray-900 dark:text-white">{{ __('My Profile') }}</h1>

        {{-- Profile Section --}}
        <div class="mb-8 rounded-xl bg-white p-8 shadow-lg dark:bg-gray-900">
            <h2 class="mb-6 text-xl font-semibold text-gray-900 dark:text-white">{{ __('Personal Information') }}</h2>
            ...
            <form wire:submit="updateProfile" class="space-y-6">
                <div>
                    <label for="name" class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('Name') }}</label>
                ...
                <div>
                    <label for="email" class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('Email') }}</label>
        ...
        {{-- Password Section --}}
        <div class="mb-8 rounded-xl bg-white p-8 shadow-lg dark:bg-gray-900">
            <h2 class="mb-6 text-xl font-semibold text-gray-900 dark:text-white">{{ __('Change Password') }}</h2>
            ...
            <form wire:submit="updatePassword" class="space-y-6">
                <div>
                    <label for="current_password" class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('Current Password') }}</label>
                ...
                <div>
                    <label for="password_confirmation" class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('Confirm New Password') }}</label>
        ...
        <div class="rounded-xl bg-white p-8 shadow-lg dark:bg-gray-900">
            <h2 class="mb-4 text-xl font-semibold text-gray-900 dark:text-white">{{ __('Sign Out') }}</h2>
            <p class="mb-6 text-sm text-gray-600 dark:text-gray-400">
                {{ __('If you wish to close your current session, click the button below.') }}
            </p>
