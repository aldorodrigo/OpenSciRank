...
<div class="bg-gray-50 py-8 dark:bg-gray-950">
    <div class="container mx-auto max-w-5xl px-4">
        ...
        <nav class="mb-6 text-sm text-gray-500 dark:text-gray-400">
            ...
            <span class="text-gray-900 dark:text-white">Pago de Listado de Libro</span>
        </nav>

        <h1 class="mb-8 text-3xl font-bold text-gray-900 dark:text-white">Pago para Listado de Libro</h1>
