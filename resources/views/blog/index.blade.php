<x-layouts.app title="{{ __('Blog') }} - Editorial Standards Platform" :description="__('Resources, guides and news on Open Science, scientific journal indexing and good editorial practices.')">
        ...
        <div class="container mx-auto px-4">
            <div class="relative overflow-hidden rounded-3xl bg-indigo-600 p-8 text-center text-white shadow-2xl md:p-12">
                ...
                <div class="relative z-10 mx-auto max-w-2xl">
                    ...
                    <p class="mt-4 text-xs font-medium text-white/60">{{ __('No spam. You can unsubscribe at any time.') }}</p>
                </div>
            </div>
        </div>
    </section>
