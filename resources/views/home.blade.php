<x-layouts.app :title="__('Editorial Standards Platform - Editorial Evaluation for Scientific Journals')" :description="__('Global platform for technical evaluation and visibility for scientific journals. Transparent criteria, Editorial Standards Seal and academic publications directory.')">
    ...
    {{-- Hero Section --}}
    <section class="relative min-h-[80vh] flex items-center overflow-hidden bg-blue-900 text-white">
        {{-- High-end background --}}
        <div class="absolute inset-0 z-0">
            <div class="absolute inset-0 bg-brand-deep opacity-90"></div>
            ...
            {{-- Animated-like blurs --}}
            <div class="absolute -left-1/4 -top-1/4 h-[80%] w-[80%] rounded-full bg-blue-500/30 blur-[120px]"></div>
            <div class="absolute -right-1/4 -bottom-1/4 h-[80%] w-[80%] rounded-full bg-blue-500/20 blur-[120px]"></div>
        </div>
        ...
        <div class="container relative z-10 mx-auto px-4 py-24 text-center">
            ...
            <p class="mx-auto mt-8 max-w-2xl text-xl text-blue-100/90 leading-relaxed">
            ...
            <div class="mx-auto mt-6 inline-flex flex-wrap items-center justify-center gap-3 text-sm font-medium text-blue-200/80">
                <span class="rounded-full bg-white/10 px-4 py-1.5 backdrop-blur-sm border border-white/10">{{ __('17 indicators') }}</span>
                <span class="text-blue-300/50">&middot;</span>
            ...
            <div class="mt-12 flex flex-col items-center justify-center gap-5 sm:flex-row">
                <a href="/register" class="group relative inline-flex items-center justify-center overflow-hidden rounded-2xl bg-white px-10 py-5 text-lg font-bold text-brand shadow-2xl transition-all hover:scale-105 hover:bg-blue-50 active:scale-95">
            ...
            >
                <div class="grid grid-cols-2 gap-6 md:grid-cols-3 lg:gap-8">
                    ...
                    <div class="group rounded-2xl bg-gradient-to-br from-blue-50 to-white p-6 text-center transition hover:shadow-lg dark:from-blue-950/50 dark:to-gray-900 lg:p-8">
                        ...
                        <div class="text-4xl font-extrabold text-brand dark:text-blue-400 lg:text-5xl" data-target="{{ $journalCount }}">0</div>
                    ...
                    {{-- Países --}}
                    <div class="group rounded-2xl bg-slate-50 p-6 text-center transition hover:shadow-lg dark:from-blue-950/50 dark:to-gray-900 lg:p-8">
                        <div class="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-xl bg-blue-100 text-brand dark:bg-blue-900/50 dark:text-blue-400">
                            <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M12 21a9.004 9.004 0 008.716-6.747M12 21a9.004 9.004 0 01-8.716-6.747M12 21c2.485 0 4.5-4.03 4.5-9S14.485 3 12 3m0 18c-2.485 0-4.5-4.03-4.5-9S9.515 3 12 3m0 0a8.997 8.997 0 017.843 4.582M12 3a8.997 8.997 0 00-7.843 4.582m15.686 0A11.953 11.953 0 0112 10.5c-2.998 0-5.74-1.1-7.843-2.918m15.686 0A8.959 8.959 0 0121 12c0 .778-.099 1.533-.284 2.253m0 0A17.919 17.919 0 0112 16.5c-3.162 0-6.133-.815-8.716-2.247m0 0A9.015 9.015 0 003 12c0-1.605.42-3.113 1.157-4.418" /></svg>
                        </div>
                        <div class="text-4xl font-extrabold text-brand dark:text-blue-400 lg:text-5xl" data-target="{{ $countryCount }}">0</div>
    ...
    <section class="bg-gray-50 py-20 dark:bg-gray-950">
        <div class="container mx-auto px-4">
                ...
                <a href="{{ route('journal.show', $fj->slug) }}" class="group rounded-xl border border-gray-200 bg-white p-6 transition hover:border-blue-300 hover:shadow-lg dark:border-gray-700 dark:bg-gray-800 dark:hover:border-brand" style="text-decoration:none;">
                    <div class="mb-4 flex items-center gap-4">
                        ...
                        <div class="min-w-0 flex-1">
                            <h3 class="truncate font-semibold text-gray-900 group-hover:text-brand dark:text-white dark:group-hover:text-blue-400">{{ $fj->getTranslationWithFallback('title') }}</h3>
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        ...
                        @elseif($fj->current_score)
                            <span class="inline-flex rounded-full bg-blue-100 px-3 py-1 text-xs font-bold text-blue-800 dark:bg-blue-900/50 dark:text-blue-400">
                                Evaluated
                            </span>
                        @else
            ...
            <div class="mt-10 text-center">
                <a href="/search" class="inline-flex items-center font-semibold text-brand transition hover:text-blue-500 dark:text-blue-400" style="cursor:pointer;">
    ...
    <section class="bg-white py-20 dark:bg-gray-900">
        <div class="container mx-auto px-4">
            ...
            <div class="mx-auto grid max-w-5xl gap-6 md:grid-cols-2">
                {{-- Journals --}}
                <a href="{{ locale_path('/search') }}" class="group relative overflow-hidden rounded-2xl border border-gray-200 bg-white p-8 transition hover:-translate-y-1 hover:border-blue-300 hover:shadow-xl dark:border-gray-700 dark:bg-gray-800 dark:hover:border-brand">
                    ...
                    <div class="relative">
                        <div class="mb-5 flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-brand dark:text-blue-400">{{ __('Evaluated and certified') }}</p>
                            </div>
                        </div>
                        ...
                        <div class="mt-6 flex items-end justify-between">
                            <div>
                                <p class="text-4xl font-extrabold text-brand dark:text-blue-400">{{ $journalCount }}</p>
            ...
            <div class="relative mx-auto max-w-5xl">
                ...
                <div class="grid gap-8 md:grid-cols-3">
                    <div class="relative text-center">
                        ...
                        <div class="mb-2 text-xs font-bold uppercase tracking-widest text-brand dark:text-blue-400">{{ __('Step 1') }}</div>
                    ...
                    <div class="relative text-center">
                        <div class="mx-auto mb-6 flex h-24 w-24 items-center justify-center rounded-2xl bg-blue-100 text-4xl dark:bg-blue-900/50">🔍</div>
                        <div class="mb-2 text-xs font-bold uppercase tracking-widest text-brand dark:text-blue-400">{{ __('Step 2') }}</div>
    ...
    <section class="relative py-20 overflow-hidden bg-white dark:bg-gray-900">
        <div class="container mx-auto px-4">
            <div class="relative overflow-hidden rounded-3xl bg-brand p-8 text-center text-white shadow-2xl md:p-16">
                ...
                <div class="absolute -bottom-32 -left-32 h-96 w-96 rounded-full bg-blue-400/20 blur-3xl"></div>
                ...
                <div class="relative z-10">
                    ...
                    <div class="mt-12 flex flex-col items-center justify-center gap-4 sm:flex-row">
                        <a href="/register" class="group relative inline-flex items-center justify-center overflow-hidden rounded-xl bg-white px-10 py-4 font-bold text-brand shadow-lg transition-all hover:scale-105 hover:shadow-xl active:scale-95">
