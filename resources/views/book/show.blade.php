    ...
    <div class="border-b border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-950">
        <div class="container mx-auto px-4 py-3">
            <nav class="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
                <a href="/" class="transition hover:text-indigo-600 dark:hover:text-indigo-400">{{ __('Home') }}</a>
                <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
                <a href="/search?type=books" class="transition hover:text-indigo-600 dark:hover:text-indigo-400">{{ __('Academic Books') }}</a>
                <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
        ...
        <div class="container mx-auto px-4 text-center">
            <div class="relative overflow-hidden rounded-3xl bg-indigo-600 p-8 text-center text-white shadow-xl md:p-12">
                ...
                <div class="relative z-10">
                    ...
                    <p class="mx-auto mt-4 max-w-xl text-indigo-100">{{ __('Index your book in Editorial Standards Platform and facilitate its discovery in the scientific ecosystem.') }}</p>
